...
// Retrieve all Virtual Machine Names
...
Client.prototype.getDatastores = function() {
  ...
  this.getMORefsInContainerByTypePropertyArray( rootFolder, 'Datastore', ['summary'] )
    .once('result', function(result) {
      emitter.emit('result', result.returnval);
    })
    .once('error', function(err) {
...
Client.prototype.getAllResourcePools = function() {
  ...
  this.getMORefsInContainerByTypePropertyArray( rootFolder, 'ResourcePool', ['summary'] )
    .once('result', function(result) {
      emitter.emit('result', result.returnval);
    })
    .once('error', function(err) {
...
Client.prototype.createResourcePool = function( name ) {
  ...
  this.runCommand( 'CreateresourcePool', { _this: rootFolder, name: 'Training', spec: ResourceConfigSpec} )
    .once('result', function(result) {
      emitter.emit('result', result.returnval);
    })
    .once('error', function(err) {
