...
// TODO: Fix this. Multipe folders with same name, nested folders, etc.
      ...
      _.forEach(templateFolders, function(templateFolder) {
        ...
        self.getMORefsInContainerByTypePropertyArray( templateFolder, 'VirtualApp', ['name'] )
          .once('result', function(result) {
            ...
            vAppArray.push( result );
 
            if(vAppArray.length === templateFolders.length) {

              console.log(util.inspect(vAppArray, {depth:null}));
