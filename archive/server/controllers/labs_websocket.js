...
var Lab = require('../models/lab'),
  ...
  Vsphere = require('vsphere'),
  util = require('util'),
  _ = require('lodash');

var TaskManager = require('../utils/taskmanager');

//var vsphere = undefined;
var vsphere = {
  auth: {
    user: '',
    pass: ''
...
/*
* Update vSphere Settings
*/
exports.updateSettings = function(vsphere_info) {
  if(vsphere_info === undefined)
    return;
  vsphere = vsphere_info;
  vc = undefined;
}
